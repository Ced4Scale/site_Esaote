...
//
// tempsInstallationMinutes : temps moyen d'installation du patient AVANT le début de
// l'acquisition (déshabillage, positionnement, consignes) — n'entre PAS dans le calcul de
// consommation électrique (déjà couvert par l'état "prêt"), mais s'ajoute à
// dureeAcquisitionMinutes pour obtenir la durée RÉELLE d'un créneau patient, utilisée pour
// vérifier qu'une activité saisie (patients/jour) reste physiquement réalisable. Chiffres
// communiqués par Cédric le 11/08/2026 : 10 min pour un scanner, 15 min pour une IRM tunnel
// (aimant supraconducteur, toutes marques hors Esaote), 10 à 20 min pour une IRM Esaote selon
// le modèle — répartition retenue : O-scan 10 (extrémités seules, positionnement simple),
// S-scan/G-scan/I-Genius 15, Magnifico 20 (corps entier, table plus grande).
//
