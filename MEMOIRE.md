...
- Examens métal / rachis : ajout d'une planche "vis par vis" reconstruite depuis le volume DICOM 3D HYCE. Six vis sont proposées sous forme de vignettes, chacune ouvrant une pile MPR dans l'axe de la vis et une pile MPR orthogonale pré-calculées.
